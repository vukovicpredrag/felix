...
class DirektoriCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return Direktori::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('pretitle', 'Naslov '),
            TextField::new('quote', 'Quote'),
            TextField::new('ctaText', 'CTA Tekst'),
